...
function [outlier,Psi] = associate(S_bar,z,W,Lambda_psi,Q)
    ...
    %as the code in lab notes is very slow Instead, we are using the diagonals of the Q matrix to save a lot of
    ...
    Psi = zeros(n,M);
    for i=1:n
        %We do z - z_hat. We have to resize in order to be able to do the
        %substraction
